...
print("data generation script used to produce anti-biased 10000 test data 001")
# define constants
...
def wave_to_file(wav, wav2=None, fname="temp", amp=0.1):
    ...
    try:
        wavfile.write(f"../../audio/anti-biased_test/{fname}.wav", SR, wav)
    except FileNotFoundError:
        os.makedirs('../../audio/anti-biased_test/')
        wavfile.write(f"../../audio/anti-biased_test/{fname}.wav", SR, wav)
...
if __name__ == "__main__":
    ...
    metadata_df = generate_metadata_file(nb_sample=NB_SAMPLE, major_prop=0.5, bias="wave_shape", 
            bias_type = {"major":"square", "minor":"sine"}, bias_strength=1.0, noise_level = 0.0,
            controlling_factors={"amplitude":"stable", "freq_range": FREQ_RANGE, "wave_shape":"sine"},
            data_use="train")
    saved_path = "/rds/general/user/cl222/home/audio/metadata_anti-biased_test.csv" ## CHANGE ME
