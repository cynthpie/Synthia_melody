...
if __name__=="__main__":
    ...
    # sine_train_data = CynthiaDataset(metadata_sine_train, sine_train_path, transform)
    # square_train_data = CynthiaDataset(metadata_square_train, square_train_path, transform)
    # sawtooth_train_data = CynthiaDataset(metadata_sawtooth_train, sawtooth_train_path, transform)
    # triangle_train_data = CynthiaDataset(metadata_triangle_train, triangle_train_path, transform)
    ...
    # torch.save(sine_train_ds, "/rds/general/user/cl222/home/msc_project/classification/sine_train_data.pt")
    # torch.save(sine_val_ds, "/rds/general/user/cl222/home/msc_project/classification/sine_val_data.pt")
    # torch.save(square_train_ds, "/rds/general/user/cl222/home/msc_project/classification/square_train_data.pt")
    # torch.save(square_val_ds, "/rds/general/user/cl222/home/msc_project/classification/square_val_data.pt")
    # torch.save(sawtooth_train_ds, "/rds/general/user/cl222/home/msc_project/classification/sawtooth_train_data.pt")
    # torch.save(sawtooth_val_ds, "/rds/general/user/cl222/home/msc_project/classification/sawtooth_val_data.pt")
    # torch.save(triangle_train_ds, "/rds/general/user/cl222/home/msc_project/classification/triangle_train_data.pt")
    # torch.save(triangle_val_ds, "/rds/general/user/cl222/home/msc_project/classification/triangle_val_data.pt")

    data = torch.load("square_train_data.pt")
    print(len(data))

    # test data
    sine_test_ds = CynthiaDataset(metadata_sine_test, sine_test_path, transform)
    # square_test_ds = CynthiaDataset(metadata_square_test, square_test_path, transform)
    # sawtooth_test_ds = CynthiaDataset(metadata_sawtooth_test, sawtooth_test_path, transform)
    # triangle_test_ds = CynthiaDataset(metadata_triangle_test, triangle_test_path, transform)
    ...
    torch.save(sine_test_ds, "/rds/general/user/cl222/home/msc_project/classification/sine_test_data.pt")
    # torch.save(square_test_ds, "/rds/general/user/cl222/home/msc_project/classification/square_test_data.pt")
    # torch.save(sawtooth_test_ds, "/rds/general/user/cl222/home/msc_project/classification/sawtooth_test_data.pt")
    # torch.save(triangle_test_ds, "/rds/general/user/cl222/home/msc_project/classification/triangle_test_data.pt")
